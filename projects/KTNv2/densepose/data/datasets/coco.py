...
DATASETS += [
    CocoDatasetInfo(
        name="densepose_coco_2014_trainval_syn_on_instances",
        images_root="coco/trainval2014_syn_on_instance",
        annotations_fpath="coco/annotations/densepose_coco_trainval2014_syn_on_instances.json",
    ),
]

DATASETS += [
    CocoDatasetInfo(
        name="densepose_coco_2014_trainval_syn_on_instances_54k",
        images_root="coco/trainval2014_syn_on_instance_54k",
        annotations_fpath="coco/annotations/densepose_coco_trainval2014_syn_on_instances_54k.json",
    ),
]

DATASETS += [
    CocoDatasetInfo(
        name="parsing_coco_2014_val",
        images_root="coco_parsing/images/val_img",
        annotations_fpath="coco_parsing/annotations/coco_parsing_val.json",
    ),
]
