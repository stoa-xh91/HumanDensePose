...
class Bottleneck2Block(CNNBlockBase):
    """
    ...
    for idx, stage_idx in enumerate(range(2, max_stage_idx + 1)):
        ...
        if depth in [18, 34]:
            ...
            if deform_on_per_stage[idx]:
                ...
                stage_kargs["block_class"] = Bottleneck2Block
        blocks = make_stage(**stage_kargs)
        in_channels = out_channels
        out_channels *= 2
        bottleneck_channels *= 2
        stages.append(blocks)
    return Res2Net(stem, stages, out_features=out_features).freeze(freeze_at)
